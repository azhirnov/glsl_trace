...
void main ()
{
	...
	imageStore( un_Output, ivec2(gl_LaunchIDNV), payload );
		...
		CHECK_ERR( vulkan.Compile( OUT rayGenShader, {rt_shader, raygen_shader_source}, SPV_COMP_SHADER_TYPE_RAY_GEN, SPV_COMP_DEBUG_MODE_CLOCK_HEATMAP, 1 ));
	}
...
extern bool ClockMap_Test2 (Device& vulkan)
{
	...
	std::cout << "ClockMap_Test2 - passed" << std::endl;
	return true;
}
