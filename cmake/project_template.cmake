...
target_compile_definitions( "ProjectTemplate" PUBLIC ${COMPILER_DEFINITIONS} )
target_link_libraries( "ProjectTemplate" PUBLIC "${LINK_LIBRARIES}" )
...
if (${CI_BUILD})
	target_compile_definitions( "ProjectTemplate" PUBLIC "CI_BUILD" )
endif ()
